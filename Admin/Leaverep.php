...
<link rel="stylesheet" href="./Tyler/leaverep_up1.css">
...
<nav class="navbar navbar-expand-lg  py-4 px-4" style="background-color: #000">
            ...
            <section class=" px-4 sect active" id="s1">
                ...
                <form action="./PHPS/leavelogic.php" class="lowerpart d-flex" method="POST" id="tableform">
                    ...
                    <input type="hidden" name="deletethisid" id="deletethisid1">
                </form>
            </section>
</nav>
...
<script src="./js/newleave.js"></script>
