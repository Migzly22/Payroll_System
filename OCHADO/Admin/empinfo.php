...
<script src="./js/empinfo1.js" defer></script>
            ...
            <section class="container px-4 sect active" id="s1">
                <form class="toppart d-flex justify-content-between my-3" method="post">
                    ...
                    <div class="d-flex gap-3 slidebtn">
                        <a class="btn" id="Addemp" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                ...
                <form action=""  method="POST" class="lowerpart d-flex container ">
                                    ...
                                    <tr id='tr".$i."'>
                                        ...
                                        <td>
                                            <div class='d-flex align-item-center gap-3 slidebtn'>
                                                <button class='btn' id='".$i."' onclick= 'editting(this.id)'>
        ...
        <form action="./PHPS/empinfo.php" method="POST">
            ...
            <div  class="d-flex gap-1">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" required id="phone" name="phone" placeholder="name@example.com">
